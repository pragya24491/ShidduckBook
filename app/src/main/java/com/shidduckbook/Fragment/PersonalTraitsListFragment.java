 ...
 */
public class PersonalTraitsListFragment extends RootFragment implements OnStartDragListener {
    ...
    private JsonArray personal_preference;

    /*  public PersonalTraitsListFragment(ArrayList<String> traitsList) {
          this.stringArrayList = traitsList;
      }*/

    public PersonalTraitsListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_personal_traits_list, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                personal_preference = new JsonArray();
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    personal_preference.add(jsonObject);

                    Log.v(TAG, "Json object personal_preference :- " + jsonObject);
                    Log.v(TAG, "Json Array personal_preference :- " + personal_preference);
                }

               /* {"method":"add_personal_preference_traits","user_id":"2", "personal_preference": [{"preference_number": "1",
                        "traits_name": "shy"},{"preference_number": "2", "traits_name": "friendly"}]} */

                JsonObject mainJsonObject = new JsonObject();
                mainJsonObject.addProperty(AppConstant.KEY_METHOD, AppConstant.METHOD.ADD_PERSONAL_PREFERENCE_TRAITS);
                mainJsonObject.addProperty(AppConstant.KEY_USER_ID, AppPreferences.getUserId(getActivity()));
                mainJsonObject.add("personal_preference", personal_preference);
                Log.v(TAG, "Request Json Personal Preference :- " + mainJsonObject);

                addPersonalPrefTask(mainJsonObject);
    ...
    private void addPersonalPrefTask(JsonObject mainJsonObject) {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("200")) {
                        ...
                        AppPreferences.setPersonalPreferenceStatus(getActivity(), "1");
    ...
    private void setAdapter(final ArrayList<String> stringArrayList) {
        ...
        dragDropAdapter = new MyDragDropAdapter(getActivity(), stringArrayList, this, new MyDragDropAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int view, int position) {
                ...
                for (String s : stringArrayList) {
                    ...
                    Log.v(TAG, " String name :- " + s + " and position :- " + stringArrayList.get(position));
...
//        Personal_Characterstics_Tab.linearLayout.setVisibility(View.VISIBLE);
